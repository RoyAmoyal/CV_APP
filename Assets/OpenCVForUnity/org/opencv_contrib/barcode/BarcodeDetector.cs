...
namespace OpenCVForUnity.BarcodeModule
{
    ...
    public class BarcodeDetector : DisposableOpenCVObject
    {
        ...
        public BarcodeDetector(string prototxt_path, string model_path)
        {
            ...
            nativeObj = barcode_BarcodeDetector_BarcodeDetector_10(prototxt_path, model_path);
        ...
        public BarcodeDetector(string prototxt_path)
        {
            ...
            nativeObj = barcode_BarcodeDetector_BarcodeDetector_11(prototxt_path);
        ...
        public BarcodeDetector()
        {
            ...
            nativeObj = barcode_BarcodeDetector_BarcodeDetector_12();
