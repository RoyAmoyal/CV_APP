...
//            string retVal = Marshal.PtrToStringAnsi(text_OCRTesseract_run_10(nativeObj, image.nativeObj, min_confidence, component_level));
...
//            string retVal = Marshal.PtrToStringAnsi(text_OCRTesseract_run_11(nativeObj, image.nativeObj, min_confidence));
...
//            string retVal = Marshal.PtrToStringAnsi(text_OCRTesseract_run_12(nativeObj, image.nativeObj, mask.nativeObj, min_confidence, component_level));
...
//            string retVal = Marshal.PtrToStringAnsi(text_OCRTesseract_run_13(nativeObj, image.nativeObj, mask.nativeObj, min_confidence));
