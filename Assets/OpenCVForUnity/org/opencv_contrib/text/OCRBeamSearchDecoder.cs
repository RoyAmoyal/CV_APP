...
namespace OpenCVForUnity.TextModule
{
    ...
    public class OCRBeamSearchDecoder : BaseOCR
    {
        ...
        public string run(Mat image, int min_confidence, int component_level)
        {
            ...
            string retVal = Marshal.PtrToStringAnsi(text_OCRBeamSearchDecoder_run_10(nativeObj, image.nativeObj, min_confidence, component_level));
        ...
        public string run(Mat image, int min_confidence)
        {
            ...
            string retVal = Marshal.PtrToStringAnsi(text_OCRBeamSearchDecoder_run_11(nativeObj, image.nativeObj, min_confidence));
        ...
        public string run(Mat image, Mat mask, int min_confidence, int component_level)
        {
            ...
            string retVal = Marshal.PtrToStringAnsi(text_OCRBeamSearchDecoder_run_12(nativeObj, image.nativeObj, mask.nativeObj, min_confidence, component_level));
        ...
        public string run(Mat image, Mat mask, int min_confidence)
        {
            ...
            string retVal = Marshal.PtrToStringAnsi(text_OCRBeamSearchDecoder_run_13(nativeObj, image.nativeObj, mask.nativeObj, min_confidence));
        ...
        public static OCRBeamSearchDecoder create(OCRBeamSearchDecoder_ClassifierCallback classifier, string vocabulary, Mat transition_probabilities_table, Mat emission_probabilities_table, int mode, int beam_size)
        {
            ...
            return OCRBeamSearchDecoder.__fromPtr__(text_OCRBeamSearchDecoder_create_10(classifier.getNativeObjAddr(), vocabulary, transition_probabilities_table.nativeObj, emission_probabilities_table.nativeObj, mode, beam_size));
        ...
        public static OCRBeamSearchDecoder create(OCRBeamSearchDecoder_ClassifierCallback classifier, string vocabulary, Mat transition_probabilities_table, Mat emission_probabilities_table, int mode)
        {
            ...
            return OCRBeamSearchDecoder.__fromPtr__(text_OCRBeamSearchDecoder_create_11(classifier.getNativeObjAddr(), vocabulary, transition_probabilities_table.nativeObj, emission_probabilities_table.nativeObj, mode));
        ...
        public static OCRBeamSearchDecoder create(OCRBeamSearchDecoder_ClassifierCallback classifier, string vocabulary, Mat transition_probabilities_table, Mat emission_probabilities_table)
        {
            ...
            return OCRBeamSearchDecoder.__fromPtr__(text_OCRBeamSearchDecoder_create_12(classifier.getNativeObjAddr(), vocabulary, transition_probabilities_table.nativeObj, emission_probabilities_table.nativeObj));
