...
namespace OpenCVForUnity.TextModule
{
    ...
    public class Text
    {
        ...
        public static ERFilter createERFilterNM1(ERFilter_Callback cb, int thresholdDelta, float minArea, float maxArea, float minProbability, bool nonMaxSuppression, float minProbabilityDiff)
        {
            ...
            return ERFilter.__fromPtr__(text_Text_createERFilterNM1_10(cb.getNativeObjAddr(), thresholdDelta, minArea, maxArea, minProbability, nonMaxSuppression, minProbabilityDiff));
        ...
        public static ERFilter createERFilterNM1(ERFilter_Callback cb, int thresholdDelta, float minArea, float maxArea, float minProbability, bool nonMaxSuppression)
        {
            ...
            return ERFilter.__fromPtr__(text_Text_createERFilterNM1_11(cb.getNativeObjAddr(), thresholdDelta, minArea, maxArea, minProbability, nonMaxSuppression));
        ...
        public static ERFilter createERFilterNM1(ERFilter_Callback cb, int thresholdDelta, float minArea, float maxArea, float minProbability)
        {
            ...
            return ERFilter.__fromPtr__(text_Text_createERFilterNM1_12(cb.getNativeObjAddr(), thresholdDelta, minArea, maxArea, minProbability));
        ...
        public static ERFilter createERFilterNM1(ERFilter_Callback cb, int thresholdDelta, float minArea, float maxArea)
        {
            ...
            return ERFilter.__fromPtr__(text_Text_createERFilterNM1_13(cb.getNativeObjAddr(), thresholdDelta, minArea, maxArea));
        ...
        public static ERFilter createERFilterNM1(ERFilter_Callback cb, int thresholdDelta, float minArea)
        {
            ...
            return ERFilter.__fromPtr__(text_Text_createERFilterNM1_14(cb.getNativeObjAddr(), thresholdDelta, minArea));
        ...
        public static ERFilter createERFilterNM1(ERFilter_Callback cb, int thresholdDelta)
        {
            ...
            return ERFilter.__fromPtr__(text_Text_createERFilterNM1_15(cb.getNativeObjAddr(), thresholdDelta));
        ...
        public static ERFilter createERFilterNM1(ERFilter_Callback cb)
        {
            ...
            return ERFilter.__fromPtr__(text_Text_createERFilterNM1_16(cb.getNativeObjAddr()));
        ...
        public static ERFilter createERFilterNM2(ERFilter_Callback cb, float minProbability)
        {
            ...
            return ERFilter.__fromPtr__(text_Text_createERFilterNM2_10(cb.getNativeObjAddr(), minProbability));
        ...
        public static ERFilter createERFilterNM2(ERFilter_Callback cb)
        {
            ...
            return ERFilter.__fromPtr__(text_Text_createERFilterNM2_11(cb.getNativeObjAddr()));
        ...
        public static ERFilter createERFilterNM1(string filename, int thresholdDelta, float minArea, float maxArea, float minProbability, bool nonMaxSuppression, float minProbabilityDiff)
        {
            ...
            return ERFilter.__fromPtr__(text_Text_createERFilterNM1_17(filename, thresholdDelta, minArea, maxArea, minProbability, nonMaxSuppression, minProbabilityDiff));
        ...
        public static ERFilter createERFilterNM1(string filename, int thresholdDelta, float minArea, float maxArea, float minProbability, bool nonMaxSuppression)
        {
            ...
            return ERFilter.__fromPtr__(text_Text_createERFilterNM1_18(filename, thresholdDelta, minArea, maxArea, minProbability, nonMaxSuppression));
        ...
        public static ERFilter createERFilterNM1(string filename, int thresholdDelta, float minArea, float maxArea, float minProbability)
        {
            ...
            return ERFilter.__fromPtr__(text_Text_createERFilterNM1_19(filename, thresholdDelta, minArea, maxArea, minProbability));
        ...
        public static ERFilter createERFilterNM1(string filename, int thresholdDelta, float minArea, float maxArea)
        {
            ...
            return ERFilter.__fromPtr__(text_Text_createERFilterNM1_110(filename, thresholdDelta, minArea, maxArea));
        ...
        public static ERFilter createERFilterNM1(string filename, int thresholdDelta, float minArea)
        {
            ...
            return ERFilter.__fromPtr__(text_Text_createERFilterNM1_111(filename, thresholdDelta, minArea));
        ...
        public static ERFilter createERFilterNM1(string filename, int thresholdDelta)
        {
            ...
            return ERFilter.__fromPtr__(text_Text_createERFilterNM1_112(filename, thresholdDelta));
        ...
        public static ERFilter createERFilterNM1(string filename)
        {
            ...
            return ERFilter.__fromPtr__(text_Text_createERFilterNM1_113(filename));
        ...
        public static ERFilter createERFilterNM2(string filename, float minProbability)
        {
            ...
            return ERFilter.__fromPtr__(text_Text_createERFilterNM2_12(filename, minProbability));
        ...
        public static ERFilter createERFilterNM2(string filename)
        {
            ...
            return ERFilter.__fromPtr__(text_Text_createERFilterNM2_13(filename));
        ...
        public static ERFilter_Callback loadClassifierNM1(string filename)
        {
            ...
            return ERFilter_Callback.__fromPtr__(text_Text_loadClassifierNM1_10(filename));
        ...
        public static ERFilter_Callback loadClassifierNM2(string filename)
        {
            ...
            return ERFilter_Callback.__fromPtr__(text_Text_loadClassifierNM2_10(filename));
        ...
        public static OCRHMMDecoder_ClassifierCallback loadOCRHMMClassifierNM(string filename)
        {
            ...
            return OCRHMMDecoder_ClassifierCallback.__fromPtr__(text_Text_loadOCRHMMClassifierNM_10(filename));
        ...
        public static OCRHMMDecoder_ClassifierCallback loadOCRHMMClassifierCNN(string filename)
        {
            ...
            return OCRHMMDecoder_ClassifierCallback.__fromPtr__(text_Text_loadOCRHMMClassifierCNN_10(filename));
        ...
        public static OCRHMMDecoder_ClassifierCallback loadOCRHMMClassifier(string filename, int classifier)
        {
            ...
            return OCRHMMDecoder_ClassifierCallback.__fromPtr__(text_Text_loadOCRHMMClassifier_10(filename, classifier));
        ...
        public static OCRBeamSearchDecoder_ClassifierCallback loadOCRBeamSearchClassifierCNN(string filename)
        {
            ...
            return OCRBeamSearchDecoder_ClassifierCallback.__fromPtr__(text_Text_loadOCRBeamSearchClassifierCNN_10(filename));
