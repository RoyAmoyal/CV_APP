...
namespace OpenCVForUnity.TextModule
{
    ...
    public class OCRHMMDecoder : BaseOCR
    {
        ...
        public string run(Mat image, int min_confidence, int component_level)
        {
            ...
            string retVal = Marshal.PtrToStringAnsi(text_OCRHMMDecoder_run_10(nativeObj, image.nativeObj, min_confidence, component_level));
        ...
        public string run(Mat image, int min_confidence)
        {
            ...
            string retVal = Marshal.PtrToStringAnsi(text_OCRHMMDecoder_run_11(nativeObj, image.nativeObj, min_confidence));
        ...
        public string run(Mat image, Mat mask, int min_confidence, int component_level)
        {
            ...
            string retVal = Marshal.PtrToStringAnsi(text_OCRHMMDecoder_run_12(nativeObj, image.nativeObj, mask.nativeObj, min_confidence, component_level));
        ...
        public string run(Mat image, Mat mask, int min_confidence)
        {
            ...
            string retVal = Marshal.PtrToStringAnsi(text_OCRHMMDecoder_run_13(nativeObj, image.nativeObj, mask.nativeObj, min_confidence));
        ...
        public static OCRHMMDecoder create(OCRHMMDecoder_ClassifierCallback classifier, string vocabulary, Mat transition_probabilities_table, Mat emission_probabilities_table, int mode)
        {
            ...
            return OCRHMMDecoder.__fromPtr__(text_OCRHMMDecoder_create_10(classifier.getNativeObjAddr(), vocabulary, transition_probabilities_table.nativeObj, emission_probabilities_table.nativeObj, mode));
        ...
        public static OCRHMMDecoder create(OCRHMMDecoder_ClassifierCallback classifier, string vocabulary, Mat transition_probabilities_table, Mat emission_probabilities_table)
        {
            ...
            return OCRHMMDecoder.__fromPtr__(text_OCRHMMDecoder_create_11(classifier.getNativeObjAddr(), vocabulary, transition_probabilities_table.nativeObj, emission_probabilities_table.nativeObj));
        ...
        public static OCRHMMDecoder create(string filename, string vocabulary, Mat transition_probabilities_table, Mat emission_probabilities_table, int mode, int classifier)
        {
            ...
            return OCRHMMDecoder.__fromPtr__(text_OCRHMMDecoder_create_12(filename, vocabulary, transition_probabilities_table.nativeObj, emission_probabilities_table.nativeObj, mode, classifier));
        ...
        public static OCRHMMDecoder create(string filename, string vocabulary, Mat transition_probabilities_table, Mat emission_probabilities_table, int mode)
        {
            ...
            return OCRHMMDecoder.__fromPtr__(text_OCRHMMDecoder_create_13(filename, vocabulary, transition_probabilities_table.nativeObj, emission_probabilities_table.nativeObj, mode));
        ...
        public static OCRHMMDecoder create(string filename, string vocabulary, Mat transition_probabilities_table, Mat emission_probabilities_table)
        {
            ...
            return OCRHMMDecoder.__fromPtr__(text_OCRHMMDecoder_create_14(filename, vocabulary, transition_probabilities_table.nativeObj, emission_probabilities_table.nativeObj));
