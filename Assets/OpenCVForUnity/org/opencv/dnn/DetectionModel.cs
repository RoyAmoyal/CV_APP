...
namespace OpenCVForUnity.DnnModule
{
    ...
    public class DetectionModel : Model
    {
        ...
        public DetectionModel(string model, string config) :
            base(dnn_DetectionModel_DetectionModel_10(model, config))
        {
        ...
        public DetectionModel(string model) :
            base(dnn_DetectionModel_DetectionModel_11(model))
        {
        ...
        public DetectionModel(Net network) :
            base(dnn_DetectionModel_DetectionModel_12(network.nativeObj))
        {
        ...
        public DetectionModel setNmsAcrossClasses(bool value)
        {
            ...
            return new DetectionModel(dnn_DetectionModel_setNmsAcrossClasses_10(nativeObj, value));
