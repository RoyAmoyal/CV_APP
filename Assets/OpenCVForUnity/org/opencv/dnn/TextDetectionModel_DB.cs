...
namespace OpenCVForUnity.DnnModule
{
    ...
    public class TextDetectionModel_DB : TextDetectionModel
    {
        ...
        public TextDetectionModel_DB(Net network) :
            base(dnn_TextDetectionModel_1DB_TextDetectionModel_1DB_10(network.nativeObj))
        {
        ...
        public TextDetectionModel_DB(string model, string config) :
            base(dnn_TextDetectionModel_1DB_TextDetectionModel_1DB_11(model, config))
        {
        ...
        public TextDetectionModel_DB(string model) :
            base(dnn_TextDetectionModel_1DB_TextDetectionModel_1DB_12(model))
        {
        ...
        public TextDetectionModel_DB setBinaryThreshold(float binaryThreshold)
        {
            ...
            return new TextDetectionModel_DB(dnn_TextDetectionModel_1DB_setBinaryThreshold_10(nativeObj, binaryThreshold));
        ...
        public TextDetectionModel_DB setPolygonThreshold(float polygonThreshold)
        {
            ...
            return new TextDetectionModel_DB(dnn_TextDetectionModel_1DB_setPolygonThreshold_10(nativeObj, polygonThreshold));
        ...
        public TextDetectionModel_DB setUnclipRatio(double unclipRatio)
        {
            ...
            return new TextDetectionModel_DB(dnn_TextDetectionModel_1DB_setUnclipRatio_10(nativeObj, unclipRatio));
        ...
        public TextDetectionModel_DB setMaxCandidates(int maxCandidates)
        {
            ...
            return new TextDetectionModel_DB(dnn_TextDetectionModel_1DB_setMaxCandidates_10(nativeObj, maxCandidates));
