...
namespace OpenCVForUnity.DnnModule
{
    ...
    public class Model : DisposableOpenCVObject
    {
        ...
        public Model(string model, string config)
        {
            ...
            nativeObj = dnn_Model_Model_10(model, config);
        ...
        public Model(string model)
        {
            ...
            nativeObj = dnn_Model_Model_11(model);
        ...
        public Model(Net network)
        {
            ...
            nativeObj = dnn_Model_Model_12(network.nativeObj);
        ...
        public Model setPreferableBackend(int backendId)
        {
            ...
            return new Model(dnn_Model_setPreferableBackend_10(nativeObj, backendId));
        ...
        public Model setPreferableTarget(int targetId)
        {
            ...
            return new Model(dnn_Model_setPreferableTarget_10(nativeObj, targetId));
