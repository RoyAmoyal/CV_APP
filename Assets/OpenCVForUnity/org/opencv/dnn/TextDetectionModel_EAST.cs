...
namespace OpenCVForUnity.DnnModule
{
    ...
    public class TextDetectionModel_EAST : TextDetectionModel
    {
        ...
        public TextDetectionModel_EAST(Net network) :
            base(dnn_TextDetectionModel_1EAST_TextDetectionModel_1EAST_10(network.nativeObj))
        {
        ...
        public TextDetectionModel_EAST(string model, string config) :
            base(dnn_TextDetectionModel_1EAST_TextDetectionModel_1EAST_11(model, config))
        {
        ...
        public TextDetectionModel_EAST(string model) :
            base(dnn_TextDetectionModel_1EAST_TextDetectionModel_1EAST_12(model))
        {
        ...
        public TextDetectionModel_EAST setConfidenceThreshold(float confThreshold)
        {
            ...
            return new TextDetectionModel_EAST(dnn_TextDetectionModel_1EAST_setConfidenceThreshold_10(nativeObj, confThreshold));
        ...
        public TextDetectionModel_EAST setNMSThreshold(float nmsThreshold)
        {
            ...
            return new TextDetectionModel_EAST(dnn_TextDetectionModel_1EAST_setNMSThreshold_10(nativeObj, nmsThreshold));
