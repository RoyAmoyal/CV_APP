...
namespace OpenCVForUnity.VideoModule
{
    ...
    public class TrackerDaSiamRPN : Tracker
    {
        ...
        public static TrackerDaSiamRPN create(TrackerDaSiamRPN_Params parameters)
        {
            ...
            return TrackerDaSiamRPN.__fromPtr__(video_TrackerDaSiamRPN_create_10(parameters.nativeObj));
        ...
        public static TrackerDaSiamRPN create()
        {
            ...
            return TrackerDaSiamRPN.__fromPtr__(video_TrackerDaSiamRPN_create_11());
